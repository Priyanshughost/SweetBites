  ...
  return (
    <Dialog>
      <DialogTrigger asChild>
        <Card
          className="group rounded-xl border shadow-sm hover:shadow-lg/20 transition-shadow overflow-hidden cursor-pointer"
        >
          ...
          <div className="overflow-hidden">
            <img
              src={product.image}
              alt={product.name}
              className="w-full h-56 rounded-xl object-cover group-hover:scale-105 transition-transform"
            />
          </div>
